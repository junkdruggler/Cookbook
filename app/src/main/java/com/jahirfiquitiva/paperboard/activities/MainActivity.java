...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thaLatest = getResources().getString(R.string.section_latest);
        ...
        result = new Drawer()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName(thaHome).withIcon(GoogleMaterial.Icon.gmd_looks_one).withIdentifier(1),
                        new PrimaryDrawerItem().withName(thaPreviews).withIcon(GoogleMaterial.Icon.gmd_looks_two).withIdentifier(2),
                        new PrimaryDrawerItem().withName(thaApply).withIcon(GoogleMaterial.Icon.gmd_looks_3).withIdentifier(3),
                        new PrimaryDrawerItem().withName(thaLatest).withIcon(GoogleMaterial.Icon.gmd_looks_6).withIdentifier(7),
                        ...
                        if (drawerItem != null) {
                            switch (drawerItem.getIdentifier()) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    switchFragment(2, thaPreviews, "Blank");
                                    break;
                                case 3:
                                    switchFragment(3, thaApply, "Entree");
                                    break;
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    switchFragment(5, thaRequest, "Extra");
                                    break;
                                case 7:
                                    switchFragment(7, thaLatest, "Latest");
                                    break;
                                case 6:
    ...
    private void addItemsToDrawer() {
        IDrawerItem walls = new PrimaryDrawerItem().withName(thaWalls).withIcon(GoogleMaterial.Icon.gmd_looks_4).withIdentifier(4);
        IDrawerItem request = new PrimaryDrawerItem().withName(thaRequest).withIcon(GoogleMaterial.Icon.gmd_looks_5).withIdentifier(5);
        if (enable_features) {
